...
import {UilReact,UilTemperaturePlus, UilWind,UilCloudSunTear,UilSun,UilSunset } from '@iconscout/react-unicons'
  ...
  return (
    <div>
      ...
      <div className='flex flex-row items-center justify-between text-white py-3'>
       ...
       <div className='flex flex-col space-u-2'>

        <div className='flex  font-light text-sm items-center justify-center'>
        <UilTemperaturePlus size={18} className='mr-1' /> Real Fell:
        <span className='font-medium ml-1'>{`${feels_like.toFixed()}°`}</span>
        </div>

        <div className='flex  font-light text-sm items-center justify-center p-2 m-2'>
        <UilCloudSunTear size={18} className='mr-1' /> Humidity:
